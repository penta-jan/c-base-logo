...
Hier wird  von \cevain{wohnräumen} (später: \cevain{wohnungsdeckmodul}) gesprochen. 
Ob es ein solches tatsächlich einmal gegeben hat oder sogar aktuell gibt, oder ob \ceva{c-tour} hier Legenden widergibt, ist Gegenstand hitziger Debatten. 
Sicher ist, dass es eines geben \emph{soll}.
...
Beide Quellen betonen den Aspekt der \ceva{geschichte}; hier geht es um organisches Wachstum, aber auch um Verfestigung in Versteinungsprozessen, der Umwandlung kurzer Kohlenstoffverbindungen zu dauerhafteren Aggregaten wie Kohle und Diamant und das Einschließen von Erkenntnissen im Fossilbericht.
