...
\begin{newstuff}
    ...
    Der Zustand der Station erlaubt aktuell offenbar nicht den Betrieb der in~\cite{ctour} und~\cite{cbasestarbasemanual} angekündigten \ceva{cindergärten} und \ceva{schulen}, und die Station ist weiterhin nur volljährigen zugänglich. Ebenso ist die Übernachtung zur Zeit der Drucklegung als \cevain{Schlaf\-tä\-ter\-schaft} noch unzulässig~\cite[S. 58]{cbasebook}.
\end{newstuff}