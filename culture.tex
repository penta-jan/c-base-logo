...
\begin{newstuff}
    ...
    \twofonts{
        Die zentrale Antriebseinheit der Raumstation ist ein Cybernetischer Quecksilber-Reaktor (CQR), dessen Feld die c-base von der Raumzeit ausschneiden soll, um sie über die Einstein-Rosenbaum-Brücke im Orbit eines noch relativ jungen Planeten im Sternbild Cassiopeia materialisieren zu lassen.} 
