...
Dies ist die früheste Erwähnung des \cevain{centralcomputer} als \cevain{c-beam} und die erste Beschreibung von \ceva{core}.
...
\begin{newstuff}
    ...
    \ceva{core} ist Quelle von unerschöpflicher Energie, Materie und Ideen, die dann im \cevalong{Mö\-bi\-us-band-accelerator} zu sich selbst und ihrer Bedeutung in ihrer Umwelt finden.\footnote{Noch \cite{cbasestarbasemanual} spricht von \ceva{MBA-Einheiten}, also im Plural; in der späteren Literatur wird nur von \emph{dem} MBA gesprochen. Vermutlich  hat sich die Einheit der Befunde erst bei weiterer Ausgrabung herausgestellt.} 
