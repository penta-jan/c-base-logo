...
Herauszustellen ist, dass \ceva{c-tour} hier \cevain{erschaffen} mit \cevain{Wahrheit} zusammenfügt. Es wird also eine Wahrheit geschaffen, nicht bloß entdeckt; wenn dem so ist - Wahrheit also geschaffen, nicht bloß entdeckt wird - so hat das natürlich weit reichende philosophische Konsequenzen. 

Heraus sticht außerdem der Ausdruck  \ceva{focussiert beieinander:} offensichtlich ist \ceva{cience} an ein Miteinander gebunden.
