...
\definecolor{eins}{HTML}{FFFFFF} %% Ring 1  "core" - Mittelpunkt 
\definecolor{zwei}{HTML}{FF00FF} %% Ring 2  "com"
\definecolor{drei}{HTML}{00FFFF} %% Ring 3  "culture" vier Module
\definecolor{vier}{HTML}{FF7F00} %% Ring 4  "creativ" fünf Module, quasi invertiert
\definecolor{fuenf}{HTML}{AAFF00} %% Ring 5 "cience" "Fenster"
\definecolor{sechs}{HTML}{C70039} %% Ring 6 "carbon" Ring um Mittelpunkt
\definecolor{sieben}{HTML}{FFFF00} %% Ring 7 "clamp"  
