...
\fancyhead[LO]{\thesection}\label{sec:#1}
}
...
\begin{abstract}
    Dieses Dokument versammelt die wesentlichen, aktuell zuhandenen diachronen Informationen über die Rolle und Funktion der \cevain{Ringe} der Raumstation unter Berlin \cevain{\mbox{c-base}} und interpretiert die Quellen- und Sachlage.    
