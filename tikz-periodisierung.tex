...
\begin{tikzpicture}[yscale=0.5,xscale=1.3]
    ...
    \node at (2.5,125) {\cevain{cucunft}};
    
    \node [right] at (5,124) {Gegenwart};
    
    \draw[fill=gray!10] (0,124) node [left] {2024} rectangle node {Neuzeit} (5,115) node [right] {\cevain{c-booc}};
    ...
    \draw[fill=gray!30] (0,103)  node [left] {2003} rectangle node {Zwischenzeit} (5,102) node [right] {\cevain{auslagerung}};
    
    \draw[fill=gray!20] (0,102)  node [left] {2002} rectangle node {Frühzeit} (5,100) node [right] {\cevain{umcuc}};
    
    \draw[fill=gray!10] (0,100)  node [left] {2000} rectangle node {Archaische Zeit} (5,95) node [right] {\cevain{gründunc}};
